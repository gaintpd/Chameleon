...
#define S(mg, eg) make_score(mg, eg)
	...
	{ { },
	{
		...
		S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0),
		S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0),
		S(70, 180), S(0, 0), S(70, 190), S(0, 0), S(15, 208), S(0, 0), S(70, 190), S(0, 0), S(70, 180),
		S(70, 210), S(0, 0), S(130, 215), S(0, 0), S(16, 238), S(0, 0), S(130, 215), S(0, 0), S(70, 210),

		S(140, 270), S(180, 306), S(20, 308), S(270, 368), S(29, 378), S(270, 368), S(20, 308), S(180, 306), S(140, 270),
		S(190, 336), S(230, 381), S(270, 401), S(290, 410), S(30, 410), S(290, 410), S(270, 401), S(230, 381), S(190, 336),
		S(190, 286), S(240, 336), S(320, 385), S(370, 400), S(37, 400), S(370, 400), S(320, 385), S(240, 336), S(190, 286),
		S(190, 211), S(240, 261), S(340, 336), S(420, 420), S(44, 600), S(420, 420), S(340, 336), S(240, 261), S(190, 211),
		S(90, 95), S(90, 95), S(90, 95), S(110, 130), S(130, 140), S(110, 130), S(90, 95), S(90, 95), S(90, 95)
	},
	{
		// Advisor
	...
	},
	{
		...
		S(930, 970), S(920, 990), S(940, 1010), S(950, 1010), S(920, 1010), S(950, 1010), S(940, 1010), S(920, 990), S(930, 970),
		...
		S(900, 1010), S(1000, 1030), S(990, 1050), S(1030, 1050), S(1040, 1050),S(1030, 0),S(990, 1050), S(1000, 1030), S(900, 1010),
		S(930, 1010), S(1080, 1030), S(1000, 1050),S(107,1050), S(1000, 1050),S(1070,0), S(1000, 1050),S(1080, 1030), S(930, 1010),
		S(920, 1010), S(980, 1030), S(990, 1050), S(1030, 1050), S(990, 1050), S(1030, 0),S(990, 1050), S(980, 1030), S(920, 1010),
		S(900, 990), S(960, 1010), S(1030, 1030),S(970, 1030), S(940, 1000), S(970, 0), S(1030, 1030),S(960, 1010), S(900, 990),
		S(900, 970), S(900, 990), S(900, 1010), S(960, 1010), S(900, 1010), S(960, 0), S(900, 1010), S(900, 990), S(900, 970)
	},
	{
		// Cannon
		...
		S(950, 1000), S(960, 1000), S(990, 1000), S(960, 1020), S(100, 1040), S(960, 1020), S(990, 1000), S(960, 1000), S(950, 1000),

		S(960, 1000), S(960, 1000), S(960, 1000), S(960, 1020), S(100, 1040),S(960, 1020), S(960, 1000), S(960, 1000), S(960, 1000),
		S(960, 1000), S(990, 1000), S(990, 1000), S(980, 1020), S(100, 1040), S(980, 1020), S(990, 1000), S(990, 1000), S(960, 1000),
	...
	void init()
	{
		for (PieceType pt = PAWN; pt <= KING; ++pt)
		{
			...
			for (Square s = SQ_A0; s <= SQ_I9; ++s)
				psq[BLACK][pt][~s] = -(psq[WHITE][pt][s] = v + Bonus[pt][s] / 12);
		}
	}
